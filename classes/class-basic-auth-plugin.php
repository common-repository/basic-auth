...
class Basic_Auth_Plugin extends WPDesk_Plugin_1_9 {
	...
	public function __construct( $base_file, $plugin_data ) {
		...
		$this->plugin_namespace = 'basic-auth';
		$this->plugin_text_domain = 'basic-auth';
	...
	public function init_dependencies() {
		require_once 'class-basic-auth-settings-hooks.php';
		$this->settings_hooks = new Basic_Auth_Settings_Hooks( $this );
		$this->settings_hooks->hooks();

		require_once 'class-admin-bar.php';
		$this->admin_bar = new Basic_Auth_Admin_Bar( $this );
	...
	public function links_filter( $links ) {
		...
		$this->settings_url = admin_url( 'options-general.php?page=basic-auth-settings' );
